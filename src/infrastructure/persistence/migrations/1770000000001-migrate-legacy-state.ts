...
type LegacyBooking = Omit<BookingPrimitives, 'currency' | 'paymentId'> & {
  currency?: string;
  paymentId?: string;
...
interface LegacyState {
  ...
  promotions?: PromotionPrimitives[];
...
async function insertPromotion(
  queryRunner: QueryRunner,
  promotion: PromotionPrimitives,
) {
  await queryRunner.query(
    `INSERT INTO promotions
      (id, name, description, discount_percent, scope, city, provider_id,
  ...
  await queryRunner.query(
    `INSERT INTO bookings
      (id, user_id, pet_id, provider_id, service_type, visit_mode,
       scheduled_at, address, notes, status, total, currency, payment_method,
